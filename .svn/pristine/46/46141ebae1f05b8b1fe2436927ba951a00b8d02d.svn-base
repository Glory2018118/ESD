...
<head>
  <meta charset="utf-8" />
  <title>Sprot Data | Login Page</title>
          ...
          <div class="kt-login__signin">
            ...
            <form class="kt-form" action="">
              <div class="input-group">
                <input class="form-control" type="text" placeholder="ID" name="userName" autocomplete="off">
...
<script src="assets/js/index/login.js" type="text/javascript"></script>
